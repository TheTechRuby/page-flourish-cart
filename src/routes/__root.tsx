...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Alphabet Nigerian Publishers delivers high-quality educational, academic, and inspirational books for students, teachers, professionals, and lifelong learners." },
      { name: "author", content: "Alphabet Nigerian Publishers" },
      { property: "og:title", content: "Alphabet Nigerian Publishers" },
      { property: "og:description", content: "Publishing knowledge. Inspiring generations." },
