...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Alphabet Publishers delivers high-quality educational, academic, and inspirational books for students, teachers, and lifelong learners." },
      { name: "author", content: "Alphabet Publishers" },
      { property: "og:title", content: "Alphabet Publishers" },
