...
export const books: Book[] = [
  { id: "1", title: "Citizenship and Heritage Studies", author: "Dr. Amara Okafor", description: "A comprehensive guide to abstract algebra for university students.", price: 34.99, category: "Educational", rating: 4.8, inStock: true, cover: { bg: "#1B5E20", accent: "#A5D6A7" } },
